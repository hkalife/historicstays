export const en = {
  ...
  checkout: {
    ...
    paymentStep: {
      ...
      cardNumberError: 'Enter a valid card number (13–19 digits).',
      expiryError: 'Enter a valid, non-expired date (MM/YY).',
      cvvError: 'Enter a valid CVV (3–4 digits).',
      backButton: 'Back',
