...
export const es: typeof en = {
  ...
  checkout: {
    ...
    paymentStep: {
      ...
      cvvLabel: 'CVV',
      cardNameError: 'El nombre en la tarjeta es obligatorio.',
      cardNumberError: 'Ingresa un número de tarjeta válido (13–19 dígitos).',
      expiryError: 'Ingresa una fecha válida y no vencida (MM/AA).',
      cvvError: 'Ingresa un CVV válido (3–4 dígitos).',
      backButton: 'Atrás',
